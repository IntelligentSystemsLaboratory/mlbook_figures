...
rocgrid <- function() {
	...
	# draw diagonals
	abline(0,pos/(c*neg),lty="1F")	# ascending
...
rocgrid()
values <- c(0.1,0.4)
#contours('entropy','blue','solid',2)
contour2('entropy','blue','solid',values)
#contour1('entropy','blue','dotted',p2, n2)
#contours('giniimp','violet','solid',2)
contour2('giniimp','violet',"2C",values)
#contour1('giniimp','violet','dotted',p2, n2)
#contours('dkmimp','red','solid',2)
contour2('minacc','red',"16",values)
#contour1('dkmimp','red','dotted',p2, n2)
